...
import {DataItems} from '../Data/DataIcons';
    ...
    <>
      {DataItems && DataItems.length > 0 ? (
        ...
        <div className="text-center py-16">
          <h2 className="text-2xl font-bold text-gray-700">Items Section</h2>
          <p className="text-gray-500 mt-2">Content for items will be displayed here.</p>
        </div>
      )}
    </>
  );
